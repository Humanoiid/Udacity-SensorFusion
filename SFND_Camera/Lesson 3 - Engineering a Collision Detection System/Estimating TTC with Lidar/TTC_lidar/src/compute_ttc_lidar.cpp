                     ...
                     std::vector<LidarPoint> &lidarPointsCurr, double &TTC)
{
    ...
    for (auto it = lidarPointsPrev.begin(); it != lidarPointsPrev.end(); ++it)
    {
        ...
        // with the if, the operation works when the y value is in the lane range (assume that car is at the center of the lane)
        // by the compound assignment operators, assign minimum x point (x is axial distance)
    }
